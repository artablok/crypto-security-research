...
## ⚠️ Latest Detected Scam Tokens (Solana)

| Token | Address | Type | Status |
|------|--------|------|--------|
| Fake USDT | `Vr1UbnDPTGT4AxmW6tVRQwSnMwzT9vo82pjmcCnuqtz` | Impersonation | ⚠️ Active |
| Fake USDT | `EqBwbzaRPwP8R4TSoHcF5u3daZcEmkpVeJEK3nKGAnNJ` | Impersonation | ⚠️ Active |

---

## 📢 Disclosure

These threats have been reported via:

- GitHub Security Advisory  
- Trust Wallet security channel  
